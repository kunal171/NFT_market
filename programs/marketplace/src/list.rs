...
pub fn list(
    ...
    let escrow_ata =  &ctx.accounts.token_account;
    ...
    escrow.token_account_pubkey = seller_token_account;
    escrow.mint_key = nft_mint;
...
pub struct ListNFT<'info> {
    ...
    #[account(mut,
        init,
        payer = user,
        space = 8 + 32 + 32 + 32 + 8 + 1, seeds = [b"marketplace", seller_wallet.key().as_ref()],
        bump
    )]
    pub escrow: AccountInfo<'info, Escrow>,
